...
#f.ex if we add a new variable such as BMI

##adding a variable that finds the number of extra diseases 

my_data_clean_aug <- my_data_clean %>%
  mutate(my_data_clean ,
         Disease_no = case_when(Diabetes == "no" & 
                                  CAD == "no" & 
                                  Pedal_edema == "no" ~ 0,
                                Diabetes == "yes" & 
                                  CAD == "no" & 
                                ...
                                Diabetes == "yes" & 
                                  CAD == "yes" & 
                                  Pedal_edema =="yes" ~ 3),
         Disease_type = case_when(Disease_no == 1 & 
                                    Diabetes == "yes" ~ "dm",
                                  Disease_no == 1 & 
                                    CAD == "yes" ~ "cad",
                                  Disease_no == 1 & 
